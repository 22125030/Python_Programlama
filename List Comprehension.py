...
my_word_list_1 = ["Murat","Cam","ybs","ztyo","ybs-3a"]
...
my_word_list_1 = ["Murat","Cam","ybs","ztyo","ybs-3b"]
# bu listenin tüm elemanlarını büyük karakterle yazdırıp
...
my_word_list_1_replace_comp = [x.replace("a","u").replace("A","U") for x in my_word_list_1]
